...
<html lang="en">
  <head>
    ...
    <link href="css/cquoj.css?<?=filemtime("css/cquoj.css") ?>" rel="stylesheet">
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="<?= $_COOKIE[$config["cookie_prefix"]."fluid_width"]==true?"container-fluid":"container" ?>">
          ...
          <a class="brand" href="index.php">CQUOJ</a>
            ...
            <ul class="nav" id="nav">
              <li class="dropdown" id="problem"><a class="dropdown-toggle" data-toggle="dropdown" href="problem.php">Problem <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li id="localp"><a href="problem.php#oj=CQU">Local Problems</a></li>
		  ...
		  <li id="vcontest"><a href="contest.php?virtual=1">Virtual Contests</a></li>
              ...
              <li id="discuss"><a href="discuss.php">Discuss</a></li>
                  ...
                  <li><a href="http://acm.cqu.edu.cn/blog">Team Blogs</a></li>
                  
                  <li><a href="http://acm.cqu.edu.cn/blog/2016/04/22/2016年重庆大学ACM-ICPC暑假前集训计划及暑假集训队选拔方案/">Join Us</a></li>
